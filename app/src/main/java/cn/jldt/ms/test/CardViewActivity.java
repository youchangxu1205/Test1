...
public class CardViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actors.add(new Actor("牛牛1", R.mipmap.p1));
        actors.add(new Actor("牛牛2", R.mipmap.p2));
        actors.add(new Actor("牛牛3", R.mipmap.p3));
        actors.add(new Actor("牛牛4", R.mipmap.p4));
    ...
    class Actor {
        public Actor(String name, int img) {
            this.name = name;
            this.img = img;
        }
    ...
    class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(MyAdapter.ViewHolder holder, int position) {
            ...
            holder.mImageView.setBackgroundResource(actor.img);
        }
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public ViewHolder(View itemView) {
                ...
                mImageView = (ImageView) itemView.findViewById(R.id.iv_avator);
            }
        }
    }
